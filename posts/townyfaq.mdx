...
- A: /t spawn [townname]. This may cost you B10.
...
- A: /t rank add [playername] assistant. This will add them as an assistant to the mayor of the town, allowing to build and break anything in the town, except chests.
