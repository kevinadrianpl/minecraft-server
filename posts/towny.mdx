...
**Players can become jailed if:**
    The player’s mayor/sheriffs send them to jail. An attacker who attacks a town which considers him an Enemy (Nation-relationship) dies in that Town. He is sent to the first available Jail plot of the defending town.
