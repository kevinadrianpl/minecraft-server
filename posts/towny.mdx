...
It costs B1000 to start a town, and the daily upkeep/tax costs B10 per day and will remain that way no matter how big your town gets. If you wish to buy more plot claims you can use /t buy bonus {amount} and there is a 500 plot limit on that. They cost B100 each. Every townblock that you claim will cost B15, everytime you use /t claim. Same rules apply to outposts.
...
<Note>Too long to read? Take a look at the commands below for a basic overview of what to do.</Note>
